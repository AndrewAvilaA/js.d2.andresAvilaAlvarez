...
function busqueda(){
    ...
    let resultado = productos.filter((producto)=> producto.nombre.includes(aBuscar) || producto.tipo.includes(aBuscar))
...
botonCatalogo.addEventListener("click", listarProductos)

const botonCarrito = document.getElementById("botonCarrito")

botonCarrito.addEventListener("click", calcularCarrito)
